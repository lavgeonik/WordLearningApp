...
public class TestModeTextFirstActivity extends Activity {

    ImageView imageView1, imageView2, imageView3, imageView4, imageView5;
    TextView textViewWordNumberInBase, textViewForeanWord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_mode_text_first);

        imageView1 = findViewById(R.id.imageView1TestModeTextFirst);
        imageView2 = findViewById(R.id.imageView2TestModeTextFirst);
        imageView3 = findViewById(R.id.imageView3TestModeTextFirst);
        imageView4 = findViewById(R.id.imageView4TestModeTextFirst);
        imageView5 = findViewById(R.id.imageView5TestModeTextFirst);

        textViewWordNumberInBase = findViewById(R.id.textViewNumberTextModeTestFirst);
        textViewForeanWord = findViewById(R.id.textViewForeanWordTestModeTextFirst);
    ...
    public void mainCycle() {
        ...
        textViewForeanWord.setText(flashCard.getForeignWord());
        playMP3();
