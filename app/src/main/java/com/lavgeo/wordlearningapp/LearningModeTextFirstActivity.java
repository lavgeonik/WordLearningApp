...
public class LearningModeTextFirstActivity extends Activity {
    ...
    public void createTimer(){
        ...
        timeStep_1 = new CountDownTimer(TIMER_SECONDS * 1000 + 1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                // Step 1 word show for 5 sec
                // Step 2 turn off editText, show image
                ...
                if(secondsToFinish == ((TIMER_SECONDS / 2) + 1)){
...
//        File mp3File = new File(root, mp3FileName);
    ...
    public void drawImage(String imgFileName){
        ...
        if (imgFile.exists()){
            ...
            android.widget.Toast.makeText(this, "not found jpg file " + imgFileName, android.widget.Toast.LENGTH_LONG).show();
        }
    }
